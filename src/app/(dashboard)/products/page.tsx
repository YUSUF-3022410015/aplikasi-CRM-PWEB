                ...
                <TableRow key={p.id} className="hover:bg-slate-100/30 transition-colors group">
                  ...
                  <TableCell>
                    <div className="flex gap-1 opacity-70 group-hover:opacity-100 transition-opacity">
                      {isAdmin && (
                        <>
                          <Button variant="ghost" size="icon" className="bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-700" onClick={() => openEdit(p)}>
                            <Edit className="h-4 w-4" />
                          </Button>
                          <Button variant="ghost" size="icon" className="bg-red-50 text-red-600 hover:bg-red-100 hover:text-red-700" onClick={() => setDeleteId(p.id)}>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={() => { if (deleteId) handleDelete(deleteId); setDeleteId(null); }} className="bg-red-600 text-white hover:bg-red-700">
              {t("common.delete")}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
