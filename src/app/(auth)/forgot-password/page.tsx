        ...
        {success ? (
          <div className="space-y-4 text-center animate-scale-in">
            ...
            <p className="text-sm text-muted-foreground">
              Link reset password telah dikirim ke <strong>{email}</strong>. Silakan cek inbox atau spam folder Anda.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="animate-slide-up" style={{ animationDelay: "0.3s" }}>
              <Button type="submit" className="w-full shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-shadow" disabled={loading || !email}>
                {loading ? (
                  <>
